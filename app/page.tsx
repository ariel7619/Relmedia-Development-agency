...
export default function Home() {
  return (
   ...
   justify-between py-4 px-4 md:px-8 mx-6">
        <Link href={"/"}>
          <Image
          ...
          <div className="md:flex items-center justify-between gap-y-4 my-10 gap-x-28 mx-auto">
            ...
            <section className="overflow-hidden mt-10 md:w-4/5">
              <InfiniteMovingLogos
                ...
                items={[
                  {
                    logo: "/logo/adobe.webp",
                    name: "Logo",
                  },
                  {
                    logo: "/logo/dotnet.webp",
                    name: "Logo",
                  },
                  {
                    logo: "/logo/figma.webp",
                    name: "Logo",
                  },
                  {
                    logo: "/logo/nodejs.webp",
                    name: "Logo",
                  },
                  {
                    logo: "/logo/php.webp",
        ...
        <main className="md:flex items-center justify-center space-y-6 md:space-y-0 md:gap-x-20 xl:w-4/5 2xl:w-[68%] mx-auto px-6 md:px-0">
          ...
          <div className="flex flex-col gap-y-5 md:w-1/2">
            <h1 className="text-lg md:text-2xl ">
              &quot;We&apos;ve been working with Relmedia for over 2 years and
      ...
      <footer className="bg-[#fafafa] py-10  px-6 md:px-0 md:mx-auto border-t">
        ...
        <div className="flex md:justify-center gap-x-4 mt-10">
          © 2024 Relmedia. All Rights Reserved.
